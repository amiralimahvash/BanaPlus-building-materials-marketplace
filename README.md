...
### Team
Erfan Hajheidari · Amirali Mahvash · Nima Mehrayin — E-commerce course project, Computer Engineering Dept., instructor: Dr. Nourbakhshiyan.
...
### تیم
عرفان حاج‌حیدری · امیرعلی ماهوش · نیما مهرایین — پروژه‌ی درس تجارت الکترونیک، دانشکده مهندسی کامپیوتر، استاد درس: دکتر نوربخشیان.
